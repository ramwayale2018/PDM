...
const AddOldDfxPath: React.FC = () => {
  ...
  const handleAddFolderPath = async () => {
    ...
    try {
      const response = await fetch(`${BASE_URL}api/add-old-dfx-folder-path`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ old_dfx_folder_path: folderPath }),
      });
