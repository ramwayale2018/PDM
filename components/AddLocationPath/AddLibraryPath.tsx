...
const AddLibraryPath: React.FC = () => {
  ...
  const handleAddFolderPath = async () => {
    ...
    try {
      const response = await fetch(`${BASE_URL}api/add-library-folder-path`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ library_folder_path: folderPath }),
      });
