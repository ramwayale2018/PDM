...
const RejectedEcnList: React.FC = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get(`${BASE_URL}api/ecnParts/rejected`, {
        withCredentials: true,
      });
...
const openEditPopup = (ecn: any) => {
  ...
  return (
    <div className="p-4">
      <Breadcrumb pageName="Rejected ECN List" />
      <input
        type="text"
...
export default RejectedEcnList;
