...
const ApprovedEcnList: React.FC = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get(`${BASE_URL}api/ecnParts/approved`, {
        withCredentials: true,
      });
...
const openEditPopup = (ecn: any) => {
  ...
  return (
    <div className="p-4">
      <Breadcrumb pageName="Approved ECN List" />
      <input
        type="text"
...
export default ApprovedEcnList;
